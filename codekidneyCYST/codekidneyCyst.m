...
[Acc,sensitivity,specificity,f1score]= Res50Classification(InpRes50,TarRes50);
...
[Acc,sensitivity,specificity,f1score]= CNNclassification(InpRes50,TarRes50);
disp('%%% ===== CNN Classifier PERFORMANCE=====%%%')
disp([' Accuracy = ' num2str(Acc)])
disp([' Precision = ' num2str(sensitivity)])
disp([' Specificity = ' num2str(specificity)])
disp([' F1 score = ' num2str(f1score)])
[precision,specificity,Acc,f1score] = DeepLearning(InpRes50,TarRes50);
...
[precision,specificity,Acc,f1score]= ANN(InpRes50,TarRes50);
