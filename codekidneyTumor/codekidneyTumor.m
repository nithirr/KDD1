...
[abnormal,abnormalOutlineInserted,max_area]=ZOAclass(s);
...
[Acc,sensitivity,specificity,f1score]= Res50Classificationtumor(InpRes50,TarRes50);
...
[Acc,sensitivity,specificity,f1score]= CNNclassificationtumor(InpRes50,TarRes50);
disp('%%% ===== CNN Classifier PERFORMANCE=====%%%')
disp([' Accuracy = ' num2str(Acc)])
disp([' Precision = ' num2str(sensitivity)])
disp([' Specificity = ' num2str(specificity)])
disp([' F1 score = ' num2str(f1score)])
[precision,specificity,Acc,f1score] = DeepLearningtumor(InpRes50,TarRes50);
...
[precision,specificity,Acc,f1score]= ANNtumor(InpRes50,TarRes50);
